...
export default function Register() {
  ...
  const handleEmailSignUp = async (e) => {
    ...
    try {
      ...
      login({ name: formData.fullName, email: formData.email, avatar: '👤', loginMethod: 'email' });
    } catch {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      await new Promise((resolve) => setTimeout(resolve, 2000));
      login({ name: 'Football Fan', email: 'fan@gmail.com', avatar: '⚽', loginMethod: 'google' });
    } catch {
        ...
        >
          ...
          >
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#111111] text-white/50">or continue with</span>
            </div>
          </motion.div>
          ...
          <motion.button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-white hover:bg-gray-50 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed group hover:scale-[1.02] active:scale-[0.98] text-base md:text-lg"
          >
            {isLoading ? (
          ...
          >
            <div className="flex items-center gap-3 text-white/60 text-sm">
              ...
              <span>Save your favorite football clubs</span>
            </div>
            <div className="flex items-center gap-3 text-white/60 text-sm">
              <div className="w-2 h-2 bg-accent rounded-full flex-shrink-0"></div>
            ...
            <div className="flex items-center gap-3 text-white/60 text-sm">
              <div className="w-2 h-2 bg-accent rounded-full flex-shrink-0"></div>
              <span>Access exclusive club information</span>
            </div>
          </motion.div>
